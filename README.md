...
// Main function
int main() {
 char msg[100] = "VASAN", enc[100], dec[100];
 printf("Plaintext : %s\n", msg);
 hill(msg, enc, 1);
 printf("Encrypted : %s\n", enc);
 hill(enc, dec, 0);
...
```
## OUTPUT
<img width="468" height="118" alt="image" src="https://github.com/user-attachments/assets/97997545-b558-45f1-a13e-edcf4a8035de" />
